    ...
    _pageSize: function (page, position) {
      ...
      if (data.display == "single") {
        ...
        if (position) {
          ...
          if (data.direction == "ltr") {
            prop[odd ? "right" : "left"] = data.opts.product === "list" ? -10 : pageWidth - prop.width;
            prop[odd ? "left" : "right"] = "auto";
          } else {
            prop[odd ? "left" : "right"] = data.opts.product === "list" ? -10 : pageWidth - prop.width;
      ...
      if (!data.disabled) {
        ...
        if (data.corner) {
          if (data.opts.flipalign === "vertical") {
            ...
            let posInNewCoordinate = flipMethods._translateCoordinate.call(
              this,
              e[0]
            );
